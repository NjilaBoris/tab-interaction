...
const files = [
  [
    "learning-framer-motion.md",
    "certified-azure.md",
    "building-micro-interactions.md",
    "new-projects-ideas.md",
  ],
  [
    "year-in-review.md",
...
function App() {
  ...
  return (
    <main className="min-h-screen h-dvh bg-gray-100 flex flex-col items-center justify-center p-8">
      ...
      <div
        className={`w-full max-w-2xl bg-neutral-200 ${
          isRadiusEnabled ? "rounded-2xl" : "rounded-none"
        } overflow-hidden`}
      >
        <div className="relative">
          <div className="flex relative">
            <motion.div
              className={`absolute h-full bg-white mt-1  ${
                isRadiusEnabled && "rounded-t-2xl"
              }`}
              initial={false}
              animate={{
                width: "25%",
        ...
        {/* Content */}
        <div
          className={`bg-neutral-300/80 p-6 ${
            isRadiusEnabled && "rounded-2xl"
          } mt-3`}
        >
          <motion.div
